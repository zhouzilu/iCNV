...
## Workflow overview
Number in the parentheses referring to different section in [Vignettes](https://github.com/zhouzilu/iCNV/blob/master/vignettes/iCNV-vignette.Rmd) and function details can be found [Utils](https://github.com/zhouzilu/iCNV/tree/master/utils).
```
                    NGS                                                 |               Array
