...
ngs_plr=lapply(seq_len(col(plr)), function(i) plr[,i])
ngs_plr.pos=lapply(seq(1,length(ngs.plr)),function(x){cbind(start(ref_qc),end(ref_qc))})
...
icnv.output = output_list(icnv_res0,sample_id,CN=0)
head(icnv.output)
```
